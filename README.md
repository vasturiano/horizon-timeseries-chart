...
| <b>positiveColorRange</b>([<i>[&lt;minColor&gt;, &lt;maxColor&gt;]</i> or <i>fn</i>]) | Getter/setter for the series accessor function to set the color range to use in the positive value bands. The top band gets assigned the max color, and the other bands are colored according to a linear interpolation of the color range. | `['white', 'midnightBlue']` |
| <b>negativeColorRange</b>([<i>[&lt;minColor&gt;, &lt;maxColor&gt;]</i> or <i>fn</i>]) | Getter/setter for the series accessor function to set the color range to use in the negative value bands. The top band gets assigned the max color, and the other bands are colored according to a linear interpolation of the color range. | `['white', 'crimson']` |
